...
Continue to [Lab 4 - neo4j-graphrag Library](../Lab_4_GraphRAG_Search) to load chunk embeddings and search a Neo4j knowledge graph with vector and vector-cypher retrieval.

...
search using Neo4j and AWS Bedrock (Amazon Titan Text Embeddings V2).

Run with: uv run python -m solutions.01_02_embeddings
"""
...
def create_index(driver) -> None:
    ...
    # Create new index (1024 dimensions for Titan Text Embeddings V2)
    create_vector_index(
        driver=driver,
        name=INDEX_NAME,
        label="Chunk",

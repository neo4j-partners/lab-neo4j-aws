...
async def create_company_nodes(driver: neo4j.Driver, companies: dict[str, dict]) -> None:
    """Create Company nodes from metadata."""
...
async def create_asset_manager_relationships(
    ...
    logger.info(f"Creating asset manager relationships...")
...
if __name__ == "__main__":
    ...
    asyncio.run(main(pdf_limit=args.limit, skip_metadata=args.skip_metadata))

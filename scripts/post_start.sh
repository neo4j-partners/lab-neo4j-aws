...
echo "=================================="
echo ""
echo "  # Verify AWS access and Bedrock models"
echo "  aws bedrock list-foundation-models --region us-east-1 --query 'modelSummaries[?contains(modelId, \`claude-sonnet-4\`)].modelId'"
echo ""

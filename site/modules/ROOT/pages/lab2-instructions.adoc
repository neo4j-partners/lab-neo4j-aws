...
This completes Part 1 (No-Code Track) of the workshop. Continue to xref:lab3.adoc[Lab 3: Bedrock and Agents] to set up your development environment and learn how AI agents work with LangGraph.
